...
#define  LOG_TAG    "BaconCamera.Librawutils"
#define  LOGD(...)  __android_log_print(ANDROID_LOG_DEBUG,LOG_TAG,__VA_ARGS__)


extern "C" JNIEXPORT jbyteArray JNICALL Java_com_fgnm_baconcamera_RawUtils_BitmapExtractor(JNIEnv * env, jobject obj,jbyteArray bufferBytes, jint blackLevel)
{
	char outfn[1024];
	LibRaw raw;
	jbyte* buffer;
...
extern "C" JNIEXPORT jbyteArray JNICALL Java_com_fgnm_baconcamera_RawUtils_unpackThumbnailBytes(JNIEnv * env, jobject obj, jstring jfilename)
{
	LibRaw raw;
...
extern "C" JNIEXPORT void JNICALL Java_com_fgnm_baconcamera_RawUtils_unpackRawByte(JNIEnv * env, jobject obj, jstring jfilename, jbyteArray bufferBytes, jint blackLevel, jfloat aperture, jfloat focalLength, jfloat shutterSpeed, jfloat isoSpeed)
{
...
extern "C" JNIEXPORT jint JNICALL Java_com_fgnm_baconcamera_RawUtils_unpackThumbnailToFile(JNIEnv * env, jobject obj, jstring jrawfilename, jstring jthumbfilename) {
    LibRaw raw;
...
extern "C" JNIEXPORT void JNICALL Java_com_fgnm_baconcamera_RawUtils_parseExif(JNIEnv * env, jobject obj, jstring jfilename, jobject jexifMap) {
...
extern "C" JNIEXPORT jobject JNICALL Java_com_fgnm_baconcamera_RawUtils_unpackRAW(JNIEnv * env, jobject obj, jstring jfilename) {
	int ret;
	LibRaw raw;
#define P1 raw.imgdata.idata
#define S raw.imgdata.sizes
